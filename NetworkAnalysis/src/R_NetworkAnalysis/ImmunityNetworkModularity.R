...
# Rscript ImmunityNetworkModularity.R Bipartite_MATRIX_mu1e-7_initialDiffDp1_S10P15_R-12499_Time_1750.txt
...
prt = paste(name,' Immunity:',sep="");
print(prt)
x <- Infomap_wrapper(Z = network, shuffled_matrices = network_shuffled, bipartite_groups = c('Bacteria', 'Virus'), file_prefix = name)
x$p_value_table

nameTitle = paste(name," Immunity",sep="");
out = paste("ImmunityNetwork-Modularity_",name,".png",sep="");
